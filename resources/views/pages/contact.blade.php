...
@section('content')
    <div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto text-center">
            <h1 class="text-4xl font-extrabold text-indigo-700 sm:text-5xl lg:text-6xl">
        ...
        <div class="mt-12 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {{-- Email Card --}}
            <div class="pt-6">
                <div class="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg h-full border border-gray-100">
                    <div class="-mt-6">
                        <span class="inline-flex items-center justify-center p-3 rounded-md shadow-lg bg-indigo-700">
                        ...
                        <p class="mt-2 text-base font-bold">
                            <a href="mailto:info@examdao.com" class="text-indigo-700 hover:text-indigo-900 transition-colors duration-200">
                                info@examdao.com
                            </a>
                        </p>
                    </div>
            ...
            <div class="pt-6">
                <div class="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg h-full border border-gray-100">
                    <div class="-mt-6">
                        ...
                        <p class="mt-2 text-base font-bold">
                            <a href="https://facebook.com/examdaobd" target="_blank" class="text-indigo-700 hover:text-indigo-900 transition-colors duration-200">
                                facebook.com/examdaobd
                            </a>
                        </p>
                    </div>
                </div>
