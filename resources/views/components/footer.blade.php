        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 border-b border-indigo-700 pb-10">
            ...
            <div class="col-span-2 lg:col-span-2 space-y-4">
                ...
                <div class="flex space-x-4">
                    {{-- Facebook (Better base color, yellow hover) --}}
                    ...
                    {{-- WhatsApp (Better base color, green hover) --}}
            ...
            <div class="space-y-3">
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ url('/dashboard') }}" class="text-gray-300 hover:text-yellow-400 transition">Dashboard</a></li>
                    <li><a href="{{ url('/pricing') }}" class="text-gray-300 hover:text-yellow-400 transition">Pricing</a></li>
                </ul>
            </div>
